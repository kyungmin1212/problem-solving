...
for i in word:
    wordlength[len(i)]=0
for i in word:
    if wordlength[len(i)]==0:
        wordlength[len(i)]=[i]
    else:
        wordlength[len(i)].append(i)
        wordlength[len(i)].sort()


wll=list(wordlength.keys())
wll.sort()

for i in wll:
    if len(wordlength[i])==1:
        print(wordlength[i][0],end="")
    else:
        a=list(set(wordlength[i]))
        a.sort()
